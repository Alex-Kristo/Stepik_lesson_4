...
class LoginPageLocators(object):
    ...
    EMAIL_INPUT = (By.XPATH, '//*[@id="id_registration-email"]')
    PASSWORD_INPUT = (By.XPATH, '//*[@id="id_registration-password1"]')
    CONFIRM_PASSWORD_INPUT = (By.XPATH, '//*[@id="id_registration-password2"]')
